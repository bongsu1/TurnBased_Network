...
namespace ServerCore
{
    ...
    public abstract class Session
    {
        ...
        public Define.ConnectState State { get { return (Define.ConnectState)_connectState; } }
        ...
        {
            _connectState = (int)Define.ConnectState.Connect;
            _socket = socket;
        ...
        void RegisterSend()
        {
            if (_connectState != (int)Define.ConnectState.Connect)
            { 
                return; 
            }
        ...
        {
            if (Interlocked.Exchange(ref _connectState, (int)Define.ConnectState.Connect) == 2)
            {   
                return; 
            }
